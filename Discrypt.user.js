// ==UserScript==
// @name         Discrypt
// @namespace    https://gitlab.com/An0/Discrypt
// @version      1.4.1.4
// @description  I hope people won't start calling this SDC ^_^
// @author       An0
// @license      LGPLv3 - https://www.gnu.org/licenses/lgpl-3.0.txt
// @downloadURL  https://gitlab.com/An0/Discrypt/raw/master/Discrypt.user.js
// @updateURL    https://gitlab.com/An0/Discrypt/raw/master/Discrypt.meta.js
// @icon         https://gitlab.com/An0/Discrypt/raw/master/logo.png
...
const BlacklistUrl = "https://gitlab.com/An0/Discrypt/raw/master/blacklist.txt";
                ...
                message: {
                    ...
                    embed: {
                        ...
                        author: {
                            ...
                            url: "https://gitlab.com/An0/Discrypt"
                        },
                        description: sysmsg,
                        footer: {
...
async function handleUpdate(event) {
    ...
    if(message.content == null && message.embeds != null && message.embeds.length === 1) {
        ...
        if(embed.footer != null && (embed.footer.text === "Discrypt" || embed.footer.text === "𝘚𝘪𝘮𝘱𝘭𝘦𝘋𝘪𝘴𝘤𝘰𝘳𝘥𝘊𝘳𝘺𝘱𝘵")) {
...
const messageRegex = /^([⠀-⣿]{16,}) `(?:Discrypt|𝘚𝘪𝘮𝘱𝘭𝘦𝘋𝘪𝘴𝘤𝘰𝘳𝘥𝘊𝘳𝘺𝘱𝘵)`$/;
...
async function processEmbeds(message, ignoreAttachments) {
    ...
    let embed = message.embeds[0];
    if(embed.footer == null || (embed.footer.text !== "Discrypt" && embed.footer.text !== "𝘚𝘪𝘮𝘱𝘭𝘦𝘋𝘪𝘴𝘤𝘰𝘳𝘥𝘊𝘳𝘺𝘱𝘵")) return;
       ...
       message.content = payload + " `𝘚𝘪𝘮𝘱𝘭𝘦𝘋𝘪𝘴𝘤𝘰𝘳𝘥𝘊𝘳𝘺𝘱𝘵`";
        ...
        message.embed = {
            ...
            author: {
                ...
                icon_url: "https://i.imgur.com/pFuRfDE.png",
                url: "http://gitlab.com/An0/Discrypt"
            },
            description: payload,
            footer: {
                text: "𝘚𝘪𝘮𝘱𝘭𝘦𝘋𝘪𝘴𝘤𝘰𝘳𝘥𝘊𝘳𝘺𝘱𝘵",
